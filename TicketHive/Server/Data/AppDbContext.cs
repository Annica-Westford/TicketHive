        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EventModel>().HasData(
                ...
                new EventModel()
                {
                    ...
                    EventType = "Festival",
                    Location = "Sweden",
                    DateTime = new DateTime(2023, 03, 17, 19, 00, 00),
                    TicketPrice = 150m,
                    MaxCapacity = 400,
                    SoldTickets = 89,
                    IsFullyBooked = false,
                ...
                new EventModel()
                {
                    ...
                    EventType = "Festival",
                    Location = "Spain",
                    DateTime = new DateTime(2023, 08, 30, 11, 00, 00),
                    TicketPrice = 200m,
                    MaxCapacity = 3000,
                    SoldTickets = 2439,
                    IsFullyBooked = false,
                ...
                new EventModel()
                {
                    ...
                    EventType = "Festival",
                    Location = "Serbia",
                    DateTime = new DateTime(2023, 08, 13, 13, 00, 00),
                    TicketPrice = 350m,
                    MaxCapacity = 2500,
                    SoldTickets = 570,
                    IsFullyBooked = false,
                ...
                new EventModel()
                {
                    ...
                    Location = "USA",
                    DateTime = new DateTime(2023, 07, 04, 19, 00, 00),
                    TicketPrice = 50m,
                    MaxCapacity = 1500,
                    SoldTickets = 264,
                    IsFullyBooked = false,
                ...
                new EventModel()
                {
                    ...
                    EventType = "Party",
                    Location = "USA",
                    DateTime = new DateTime(2023, 03, 24, 17, 00, 00),
                    TicketPrice = 650m,
                    MaxCapacity = 75,
                    SoldTickets = 69,
                    IsFullyBooked = false,
                ...
                new EventModel()
                {
                    ...
                    EventType = "Games",
                    Location = "Sweden",
                    DateTime = new DateTime(2023, 04, 07, 16, 00, 00),
                    TicketPrice = 890m,
                    MaxCapacity = 750,
                    SoldTickets = 630,
                    IsFullyBooked = false,
                ...
                new EventModel()
                {
                    ...
                    EventType = "Concert",
                    Location = "Sweden",
                    DateTime = new DateTime(2023, 07, 16, 20, 00, 00),
                    TicketPrice = 29m,
                    MaxCapacity = 30,
                    SoldTickets = 11,
                    IsFullyBooked = false,
                ...
                new EventModel()
                {
                    ...
                    EventType = "Concert",
                    Location = "Sweden",
                    DateTime = new DateTime(2023, 02, 28, 19, 15, 00),
                    TicketPrice = 3799m,
                    MaxCapacity = 50,
                    SoldTickets = 48,
                    IsFullyBooked = false,
